...
export const config = {
  matcher: [
    ...
    "/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|avif|png|gif|svg|ico|mp4|webm|mov|m4v|mp3|ogg|wav|m4a|aac|ttf|otf|woff2?|csv|docx?|xlsx?|zip|pdf|txt|json|map|webmanifest)).*)",
