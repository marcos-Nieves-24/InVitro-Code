/** Shared Tailwind Typography classes for lesson MDX. */
export const lessonProseClass =
...
/**
 * Shared Tailwind Typography classes for lab/assignment MDX.
 * Same prose base as lessons; lab-specific callout components handle their
 * own styling and opt out with `not-prose`.
 */
export const labProseClass = lessonProseClass;
