...
2. Completa el EDA siguiendo este flujo de trabajo:
...
3. Crea una función `eda_pipeline(df)` que automatice los pasos anteriores

4. Escribe un informe (2-3 párrafos):
