...
- Notebook de Jupyter con todos los cálculos, gráficos e interpretaciones

## Rúbrica de evaluación

| Criterio | Excelente (4 pts) | Bueno (3 pts) | Adecuado (2 pts) | Deficiente (1 pt) |
|----------|------------------|--------------|------------------|-------------|
| Identificación de distribuciones | Todas correctas | Errores menores | Una correcta | Faltante |
| Ajuste normal + gráfico Q-Q | Completo | Problemas menores | Parcial | Faltante |
| Función de estandarización | Funciona correctamente | Errores menores | Funciona parcialmente | Faltante |
| Demostración del TCL | Clara y completa | Funciona pero no es clara | Incompleta | Faltante |
