...
**Q6.** Explica por qué la exactitud es una métrica pobre para problemas de clasificación desbalanceados. Da un ejemplo concreto.
...
**Q7.** Un modelo de regresión logística da coeficientes: β₁ = 2.5 (feature A), β₂ = -0.8 (feature B). ¿Cómo interpretas estos valores?
...
**Q8.** Escribe una función en Python `plot_precision_recall_vs_threshold(model, X_val, y_val)` que grafique las curvas de precisión y sensibilidad en función del umbral de decisión (0.0 a 1.0). El gráfico debe mostrar ambas curvas en los mismos ejes con una leyenda.
