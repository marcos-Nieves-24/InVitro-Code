...
3. **b)** Preparar datos (limpiar, etiquetar, manejar valores faltantes) es ~80% del trabajo.
4. **b)** La matriz de confusión muestra TP, FP, FN, TN — mucho más informativo que solo el accuracy.
