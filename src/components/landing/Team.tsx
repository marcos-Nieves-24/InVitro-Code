...
export function Team() {
  return (
    <section id="equipo" className="bg-surface px-6 py-24">
        ...
        <Reveal delay={200}>
          <div className="mx-auto max-w-2xl rounded-2xl border border-surface-raised bg-surface-card p-8 shadow-md">
            <div className="flex flex-col items-center gap-6 md:flex-row">
              <div className="flex h-24 w-24 flex-shrink-0 items-center justify-center rounded-full bg-ink">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex justify-center gap-3 md:justify-start">
                  <a
                    href="https://github.com/marcos-Nieves-24"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 rounded-[10px] border border-surface-raised px-4 py-2 text-sm font-medium text-slate transition-all hover:border-fog hover:text-ink"
                  >
                    <GitHubIcon size={16} />
                    GitHub
                  </a>
                  <a
                    href="https://www.linkedin.com/in/marcos-alvarez-362b721a8/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 rounded-[10px] border border-surface-raised px-4 py-2 text-sm font-medium text-slate transition-all hover:border-fog hover:text-ink"
                  >
