...
export function AnswerReveal({ summary, children }: AnswerRevealProps) {
  return (
    <details className="group rounded-[12px] border border-gray-200 transition-all duration-200">
      <summary className="eyebrow flex cursor-pointer items-center gap-2 rounded-[12px] px-4 py-2.5 transition-colors duration-150 hover:bg-gray-50 [&::-webkit-details-marker]:hidden">
